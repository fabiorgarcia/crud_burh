...
- React Hook Form: Biblioteca que simplifica a criação, gerenciamento e validação de formulários, focando em desempenho e código reduzido, usando hooks para controlar o estado e validações sem re renderizar componentes excessivamente, aproveitando o HTML nativo para validações e integrando-se com TypeScript e outras bibliotecas.
- Styled Components: Estilos encapsulados e componentes reutilizáveis, evitando conflitos de classes globais e facilitando a estilização dinâmica baseada em props e temas. 
- ReactDOM: Métodos específicos do DOM que podem ser usados ​​no nível superior.
